...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #ifndef DEFAULT_Kp
      #define DEFAULT_Kp  20.786
      #define DEFAULT_Ki   0.983
      #define DEFAULT_Kd 109.908
    #endif
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 73.932
  #define DEFAULT_bedKi 1.521
  #define DEFAULT_bedKd 898.279
...
#else
#define NOZZLE_TO_PROBE_OFFSET { -44, -13.6, 0 }
#endif
